...
function EditPageContent() {
  ...
  // Active Studio Mode (either newly uploaded file or resumed session).
  // activeSession may only carry metadata at this point — CanvasStudio fetches
  // the actual PDF bytes itself via initialSessionId once it mounts.
  if ((activePdf && activePdf.arrayBuffer) || activeSession) {
