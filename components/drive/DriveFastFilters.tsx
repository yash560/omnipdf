...
export const DriveFastFilters: React.FC<DriveFastFiltersProps> = ({
  ...
  return (
    <div className="w-full px-3 sm:px-6 py-2 bg-zinc-50/80 dark:bg-zinc-900/60 border-b border-zinc-200/60 dark:border-zinc-800/60 flex items-center gap-2 sm:gap-3 overflow-x-auto no-scrollbar text-xs select-none shrink-0" style={{ touchAction: 'pan-x' }}>
      {/* People Filters */}
