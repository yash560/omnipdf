        ...
        {tools.map((t) => {
          ...
          return (
            <button
              ...
              title={t.label}
              className={`p-2 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer btn-press ${
                isActive
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center bg-zinc-100 dark:bg-zinc-800/80 rounded-xl p-0.5 border border-zinc-200 dark:border-zinc-700">
          <button
            ...
            disabled={!canUndo}
            title="Undo (Ctrl+Z)"
            className="p-1.5 rounded-lg text-zinc-600 dark:text-zinc-300 hover:bg-white dark:hover:bg-zinc-700 disabled:opacity-30 disabled:pointer-events-none transition-colors cursor-pointer btn-press"
          >
        ...
        <div className="flex items-center bg-zinc-100 dark:bg-zinc-800/80 rounded-xl px-2 py-1 border border-zinc-200 dark:border-zinc-700 text-xs font-bold text-zinc-700 dark:text-zinc-300 gap-1.5">
          <button
            onClick={onZoomOut}
            title="Zoom Out"
            className="p-0.5 hover:text-rose-500 transition-colors cursor-pointer btn-press"
          >
      ...
      <div className="flex items-center gap-2">
        {onOpenAiModal && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-xs font-extrabold shadow-md shadow-indigo-500/20 hover:shadow-lg transition-all btn-press cursor-pointer"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-rose-500 to-red-600 hover:from-rose-600 hover:to-red-700 text-white text-xs font-extrabold shadow-md shadow-rose-500/20 hover:shadow-lg transition-all btn-press cursor-pointer disabled:opacity-50"
        >
          {isExporting ? (
            <>
